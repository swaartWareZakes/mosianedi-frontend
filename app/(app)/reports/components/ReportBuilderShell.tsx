...
export default function ReportBuilderShell() {
  ...
  // This object controls everything visible in the report
  const [reportConfig, setReportConfig] = useState({
    ...
    showSurface: true,
    showCost: true,
    groupBy: "none", // none | district | criticality
  });
    ...
    <div className="flex h-full w-full bg-[var(--background)]">
      ...
      <main className="flex-1 bg-slate-100 dark:bg-slate-900/50 flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8 flex justify-center">
            {/* Pass the full config state to the preview */}
            <ReportLivePreview template={selectedTemplate} config={reportConfig} />
        </div>
      </main>
